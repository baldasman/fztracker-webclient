...
@Component({
  selector: 'app-gun-movement',
  templateUrl: './gun-movement.component.html',
  styleUrls: ['./gun-movement.component.scss']
})
export class GunMovementComponent extends Mixin(Core, Animations, Forms, Stores) implements OnInit, OnDestroy {
