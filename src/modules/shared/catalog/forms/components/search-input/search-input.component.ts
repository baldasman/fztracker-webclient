import { Component, Input, Output, OnInit, AfterViewInit, DoCheck, OnDestroy, EventEmitter, ChangeDetectionStrategy, ChangeDetectorRef, forwardRef } from '@angular/core';
